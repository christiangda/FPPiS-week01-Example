...
class ListsSuite extends FunSuite {
  ...
  test("sum of negative numbers") {
    assert(sum(List(-5, -255, -1, -66)) === -327)
  }

  test("sum of negative numbers including zero") {
    assert(sum(List(-5, -10, -20, 0, -15)) === -50)
  }

  test("sum of positive numbers including zero") {
    assert(sum(List(5, 10, 20, 0, 15)) === 50)
  }

  test("sum of positive and negative numbers including zero") {
    assert(sum(List(5, 10, 20, 0, -15, 0, -25)) === -5)
  }

  test("sum of repeated elements") {
    assert(sum(List(10, 10, 10, 10, 10, 10, 10)) === 70)
  }

  test("sum of repeated elements including zero") {
    assert(sum(List(10, 10, 10, 0, 10, 10, 10, 10, 0)) === 70)
  }

  test("sum of zeros is equal zero") {
    assert(sum(List(0)) === 0)
  }

  test("sum of empty list is equal zero") {
    assert(sum(List()) === 0)
  }
  ...
  test("max of negative numbers") {
    assert(max(List(-5, -255, -1, -66)) === -1)
  }

  test("max of negative numbers including zero") {
    assert(max(List(-5, -10, -20, 0, -15)) === 0)
  }

  test("max of positive numbers including zero") {
    assert(max(List(5, 10, 20, 0, 15)) === 20)
  }

  test("max of positive and negative numbers including zero") {
    assert(max(List(5, 10, 20, 0, -15, 0, -25)) === 20)
  }

  test("max of repeated elements") {
    assert(max(List(10, 10, 10, 10, 10, 10, 10)) === 10)
  }

  test("max of repeated elements including zero") {
    assert(max(List(10, 10, 10, 0, 10, 10, 10, 10, 0)) === 10)
  }

  test("max of zeros is equal zero") {
    assert(max(List(0)) === 0)
  }
